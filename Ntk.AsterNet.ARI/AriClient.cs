...
using Ntk.AsterNet.ARI.Dispatchers;
using Ntk.AsterNet.ARI.Middleware;
using Ntk.AsterNet.ARI.Middleware.Default;
...
namespace Ntk.AsterNet.ARI
{
    ...
    public class AriClient : BaseAriClient, IDisposable, IAriClient
    {
        ...
        private void _eventProducer_OnMessageReceived(object sender, MessageEventArgs e)
        {
            ...
            var type = Type.GetType("Ntk.AsterNet.ARI.Models." + eventName + "Event");
            var evnt =
                (type != null)
